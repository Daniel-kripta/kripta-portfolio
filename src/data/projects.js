...
const data = {
    myProjects: [
        ...
        stack: [
            ...
            { name: "React Router", type: "framework", img: undefined},
            { name: "Vite", type: "framework", img: techImg("Vite") },
            { name: "JavaScript", type: "language", img: techImg("Javascript")},
            { name: "CSS", type: "language", img: techImg("CSS") },
            { name: "HTML", type: "language", img: techImg("HTML") },
            { name: "USDA API", type: "resource", img: undefined},
            { name: "Pixabay API", type: "resource", img: undefined},
            { name: "Wikipedia API", type: "resource", img: undefined},
        ],
        id: "project-3",
